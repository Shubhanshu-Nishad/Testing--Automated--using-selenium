...
wd = webdriver.Edge(executable_path="C:\\Users\\91945\\Downloads\\edgedriver_win64\\msedgedriver.exe")
print(wd.title)
...
try:
    ...
    time.sleep(3)
    wd.find_element_by_name('Name').send_keys('Shubhanshu Nishad')
    time.sleep(3)
    wd.find_element_by_name('Email').send_keys('shubhanshunishad24@gmail.com')
    time.sleep(3)
